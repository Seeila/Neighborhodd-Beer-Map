      ...
      return (
         <article className="infoWindow">
               ...
               <main tabIndex="0">
                  ...
                  {brewerysBeers.length && (
                     <section className="beers">
                        ...
                        <p>
                           <small>
                              *The beers informations come from Untappd API
                           </small>
                        </p>
                     </section>
                  )}
                  ...
                  {!brewerysBeers.length && (
                     <section className="beers">
                        <h3>Beers</h3>
                        <p>
                           Sorry we have reached the number of visit allowed by
                           Untappd for today, please try again tomorrow
                        </p>
                     </section>
                  )}
               </main>
            ...
            {this.state.statusError && (
               <main>
                  <p tabIndex="0">
                     Sorry we couldn't load this place informations. Please try
                     again
                  </p>
               </main>
            )}
